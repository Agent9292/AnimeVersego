...
const name = row[2] || '';
const description = row[3] || '';
html += <div class="slide" style="background-image: url('${thumbnail}')">   <div class="meta">   <h3>${name}</h3>   <p>${description}</p>   </div>   </div>;
});
return html;
}
...
Acha suno ek aur help chahiye mujeh is code keh under hena slides keh joh hena mein chahta ho automatic move hova kare few seconds mein toh set ker keh doge ?    }
